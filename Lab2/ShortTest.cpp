...
//    pq2.push(6, 5);
//
//    PriorityQueue pq3 = pq1.merge(pq2);
//
//    assert(pq3.top().first == 1);
//    assert(pq3.pop().second == 5);
//    assert(pq3.top().first == 2);
//    assert(pq3.pop().second == 5);
//    assert(pq3.top().first == 3);
//    assert(pq3.pop().second == 5);
//    assert(pq3.top().first == 4);
//    assert(pq3.pop().second == 5);
//    assert(pq3.top().first == 5);
//    assert(pq3.pop().second == 5);
//    assert(pq3.top().first == 6);
//    assert(pq3.pop().second == 5);
//    assert(pq3.isEmpty() == true);
//}
